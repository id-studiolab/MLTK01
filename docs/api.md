...
- [MLTK API](#mltk-api)
  - [MLTK](#mltk)
    - [new MLTK(TrainFunction, PlayFunction)](#new-mltktrainfunction-playfunction)
    - [mltk.addTrainingData(label, features)](#mltkaddtrainingdatalabel-features)
    - [mltk.classify(features, callback)](#mltkclassifyfeatures-callback)
    - [mltk.isTrainModeActive() ⇒ boolean](#mltkistrainmodeactive--boolean)
    - [mltk.isPlayModeActive() ⇒ boolean](#mltkisplaymodeactive--boolean)
    - [mltk.isRecordButtonPressed() ⇒ boolean](#mltkisrecordbuttonpressed--boolean)
    - [mltk.getColorimeterData() ⇒ Array](#mltkgetcolorimeterdata--array)
    - [mltk.getGyroscopeData() ⇒ Array](#mltkgetgyroscopedata--array)
    - [mltk.getMagnetometerData() ⇒ Array](#mltkgetmagnetometerdata--array)
    - [mltk.getActiveClass() ⇒ Number](#mltkgetactiveclass--number)
    - [mltk.setRGBLed(r, g, b)](#mltksetrgbledr-g-b)
    - [mltk.setLedRing(index, r, g, b)](#mltksetledringindex-r-g-b)
    - [mltk.updateStatusMsg(message)](#mltkupdatestatusmsgmessage)
    - [mltk.createControlInterface()](#mltkcreatecontrolinterface)
    - [mltk.createLiveDataView()](#mltkcreatelivedataview)
    - [mltk.createTrainingDataView()](#mltkcreatetrainingdataview)
